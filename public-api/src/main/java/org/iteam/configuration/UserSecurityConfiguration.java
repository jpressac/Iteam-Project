...
// web.ignoring().antMatchers("/bower_components/**", "scripts/**/*.js",
// "scripts/**/*.jsx", "/styles/**/*",
// "/imgs/**/*.*");
// }
//
...
// http.authorizeRequests().antMatchers("/screenboard/**/*").permitAll().antMatchers(HttpMethod.GET,
// "/nose/use")
// .permitAll().antMatchers(HttpMethod.OPTIONS,
// "/**/*").permitAll().anyRequest().authenticated().and()
// .formLogin().loginPage("/login").defaultSuccessUrl("/",
// true).permitAll().and().httpBasic().and().csrf()
