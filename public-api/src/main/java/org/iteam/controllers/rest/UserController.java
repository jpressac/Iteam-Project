...
import org.iteam.configuration.google.GoogleProfile;
...
public class UserController {
	...
	public ResponseEntity<GoogleProfile> insertUser(@RequestBody LinkedMultiValueMap<String, String> tokenId)
		...
		// GoogleIdTokenVerifier tokenVerifier = new
		// GoogleIdTokenVerifier.Builder(new NetHttpTransport(), jsonFactory)
