...
public class UserServiceImplTest {
	...
	private void givenASearchResponse() {
		...
		Mockito.when(elastcisearchClient.search("test", "testType", QueryBuilders.boolQuery()))
	...
	private void givenAUserNameAndPassword(String testUserName, String testPassword) {
