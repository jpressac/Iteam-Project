...
export class ContactView extends React.Component {
  render(){
    return(
      ...
      //<Image source={require('../assets/creative.jpg')} style= {styles.backgroundImage} resizeMode={Image.resizeMode.sretch}>
      //  <Image src={require('creative')}  style={styles.container}>

      //<img align="center"  alt='creativity' className={classes.image}
        //src={creative} />
